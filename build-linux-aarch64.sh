...
chmod 644 target/StakeScape.jar
...
ARCH=arm_aarch64 ./appimagetool-x86_64.AppImage \
	...
	native-linux-aarch64/StakeScape.AppDir/ \
	native-linux-aarch64/StakeScape-aarch64.AppImage
